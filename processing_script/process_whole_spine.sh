...
sct_crop_image -i ${file_t2}_seg.nii.gz -zmin $min_z -o ${file_t2}_crop_seg.nii.gz
sct_crop_image -i ${file_t2}_seg_labeled_discs.nii.gz -zmin $min_z -o ${file_t2}_crop_seg_labeled_discs.nii.gz
